...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def __init__(self, *args, **kwargs):
     ...
     #Zooming
        ...
        #Actions for Pdf
        # self.ui.pushButton_4.clicked.connect(lambda: self.pdf())
        ...
        self.ui.pushButton_4.clicked.connect(lambda: self.save_pdf())
        #Action for save as
 ...
 #Zooming in and out 
  ...
  #Scrolling Left,right
    def scroll_right1(self):
        self.l1 -=0.2
        self.ui.Channel1.setXRange(self.l1,self.l1+1)
    def scroll_right2(self):
        self.l2 -=0.2
        self.ui.Channel2.setXRange(self.l2,self.l2+1)
    def scroll_right3(self):
        self.l3 -=0.2
        self.ui.Channel3.setXRange(self.l3,self.l3+1)

    def scroll_left1(self):
        self.r1 +=0.2
        self.ui.Channel1.setXRange(self.r1,self.r1+1)
    def scroll_left2(self):
        self.r2 +=0.2
        self.ui.Channel2.setXRange(self.r2,self.r2+1)
    def scroll_left3(self):
        self.r3 +=0.2
        self.ui.Channel3.setXRange(self.r3,self.r3+1)
